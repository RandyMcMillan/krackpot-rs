...
- `/krackpot/` opens the self-hosted Krackpot tab, which runs the mirrored `src/` tree in this repo.
- `/krackpot/source/` shows the mirrored Krackpot source files in a local browser.
...
- `src/bin/krackpot-server.rs` - Serves the built site locally from `site/`
- `demo/index.html` - Browser frontend
- `demo/krackpot/index.html` - Krackpot app shell
